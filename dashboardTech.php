            ...
            <div class="row" style="height: 100vh;">
                ...
                <div class="col-1 col-lg-1 col-xl-1 d-flex flex-column align-items-center" id="sidebar" style="background: #353535;padding-top: 1.5em;height: 90%;border-width: 2px;border-style: solid;border-top-style: none;border-right-width: 1px;border-right-style: none;border-bottom-style: none;border-left-style: none;">
                    ...
                    <?php if ($_SESSION['usuario'] == 'root') { ?>
                        <a class="text-muted sidebtn" data-toggle="tooltip" data-bs-tooltip="" data-placement="right" id="tareasAsignar   " href="#/" title="Asignar tareas" data-btn="tareasAsignar"><i class="fa fa-list-ol" style="font-size: 2.2vw;"></i></a>
                    <?php } else { ?>
                        <a class="text-muted sidebtn" data-toggle="tooltip" data-bs-tooltip="" data-placement="right" id="tareasAsignadas" href="#/" title="Tareas asignadas" data-btn="tareasAsignadas"><i class="fa fa-list-ol" style="font-size: 2.2vw;"></i></a>
                    <?php } ?>
                    ...
                    <a class="text-muted sidebtn" data-toggle="tooltip" data-bs-tooltip="" data-placement="right" id="configuraciones" href="#/" title="Configuraciones" data-btn="configuraciones"><i class="fa fa-gears" style="font-size: 2.2vw"></i></a>
        ...
        <script>
            $(document).ready(() => {
                ...
                setInterval(function() {
                    ...
                    if ($("#nombreUsuario").text() !== "Root Admin") {
                        $.ajax({
                            type: "GET",
