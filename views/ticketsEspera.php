...
$area = filtrar_depto();
$stmt = $conn->prepare("SELECT * FROM tickets $area AND estatus = 'espera'");
                            ...
                            <div class="btn-toolbar d-flex flex-row justify-content-center">
                                <div class="btn-group" role="group">
                                    ...
                                    <?php if ($ticket['estatus'] != "cerrado") { ?>
                                        <button class="btn btn-outline-warning btn-sm retomarTicket" data-toggle="modal" type="button" data-bs-tooltip="" title="Mover a tickets abiertos" data-retomar-id="<?php echo $ticket['id_ticket'] ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        sessionStorage.setItem("pagina_actual", "views/ticketsEspera.php");
        ...
        $(".retomarTicket").click(function() {
            ...
            $.ajax({
                type: "GET",
                url: `main_controller.php?id_ticket=${id}&estatus=abierto&estatusTicket=true`,
                success: function() {
                    setTimeout(function() {
                        $("#contenido").load("views/ticketsEspera.php");
                    }, 250);
